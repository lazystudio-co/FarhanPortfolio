...
const Capabilities = () => {
  ...
  return (
    <section id="competencies" className="bg-[#0a0a0a] w-full min-h-[600px] py-24 flex items-center justify-start font-[Playfair_Display,serif] border-b border-[#2a2a2a]">
